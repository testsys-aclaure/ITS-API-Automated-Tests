...
class TestTestPretestReferencesEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_test_pretest_references_payload(self) -> dict:
        """Get the minimal viable payload for /test/pretest-references endpoints."""
        return {
    ...
    def test_test_pretest_references_start(self, auth_headers):
        """Test POST //test/pretest-references/start endpoint with minimal viable payload."""
        path = "//test/pretest-references/start"
        ...
        payload = self.get_test_pretest_references_payload()
    ...
    def test_test_pretest_references_login(self, auth_headers):
        """Test POST //test/pretest-references/login endpoint with minimal viable payload."""
        path = "//test/pretest-references/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /test/pretest-references resource."""
        return ["//test/pretest-references/start", "//test/pretest-references/login"]
