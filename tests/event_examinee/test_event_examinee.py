...
class TestEventExamineeEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_event_examinee_payload(self) -> dict:
        """Get the minimal viable payload for /event/examinee endpoints."""
        return {
    ...
    def test_event_examinee_start(self, auth_headers):
        """Test POST //event/examinee/start endpoint with minimal viable payload."""
        path = "//event/examinee/start"
        ...
        payload = self.get_event_examinee_payload()
    ...
    def test_event_examinee_login(self, auth_headers):
        """Test POST //event/examinee/login endpoint with minimal viable payload."""
        path = "//event/examinee/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /event/examinee resource."""
        return ["//event/examinee/start", "//event/examinee/login"]
