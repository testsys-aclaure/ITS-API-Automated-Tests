...
class TestFormReportsEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_form_reports_payload(self) -> dict:
        """Get the minimal viable payload for /form/reports endpoints."""
        return {
    ...
    def test_form_reports_start(self, auth_headers):
        """Test POST //form/reports/start endpoint with minimal viable payload."""
        path = "//form/reports/start"
        ...
        payload = self.get_form_reports_payload()
    ...
    def test_form_reports_login(self, auth_headers):
        """Test POST //form/reports/login endpoint with minimal viable payload."""
        path = "//form/reports/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /form/reports resource."""
        return ["//form/reports/start", "//form/reports/login"]
