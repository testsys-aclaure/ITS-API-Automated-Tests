...
class TestExamineeRecordEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_examinee_record_payload(self) -> dict:
        """Get the minimal viable payload for /examinee/record endpoints."""
        return {
    ...
    def test_examinee_record_start(self, auth_headers):
        """Test POST //examinee/record/start endpoint with minimal viable payload."""
        path = "//examinee/record/start"
        ...
        payload = self.get_examinee_record_payload()
    ...
    def test_examinee_record_login(self, auth_headers):
        """Test POST //examinee/record/login endpoint with minimal viable payload."""
        path = "//examinee/record/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /examinee/record resource."""
        return ["//examinee/record/start", "//examinee/record/login"]
