"""Test suite for TIMEZONE API endpoints."""
...
class TestTimezoneEndpoints(APITestBase):
    """Test TIMEZONE resource endpoints."""
    ...
    def test_timezone_query(self, auth_headers):
        """Test /Timezone/Query endpoint."""
        path = "/Timezone/Query"
