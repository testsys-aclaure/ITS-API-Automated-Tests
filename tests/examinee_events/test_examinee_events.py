...
class TestExamineeEventsEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_examinee_events_payload(self) -> dict:
        """Get the minimal viable payload for /examinee/events endpoints."""
        return {
    ...
    def test_examinee_events_start(self, auth_headers):
        """Test POST //examinee/events/start endpoint with minimal viable payload."""
        path = "//examinee/events/start"
        ...
        payload = self.get_examinee_events_payload()
    ...
    def test_examinee_events_login(self, auth_headers):
        """Test POST //examinee/events/login endpoint with minimal viable payload."""
        path = "//examinee/events/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /examinee/events resource."""
        return ["//examinee/events/start", "//examinee/events/login"]
