...
class TestUserAccessEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_user_access_payload(self) -> dict:
        """Get the minimal viable payload for /user/access endpoints."""
        return {
    ...
    def test_user_access_start(self, auth_headers):
        """Test POST //user/access/start endpoint with minimal viable payload."""
        path = "//user/access/start"
        ...
        payload = self.get_user_access_payload()
    ...
    def test_user_access_login(self, auth_headers):
        """Test POST //user/access/login endpoint with minimal viable payload."""
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /user/access resource."""
        return ["//user/access/start", "//user/access/login"]
