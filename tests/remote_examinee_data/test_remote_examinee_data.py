...
class TestRemoteExamineeDataEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_remote_examinee_data_payload(self) -> dict:
        """Get the minimal viable payload for /remote/examinee-data endpoints."""
        return {
    ...
    def test_remote_examinee_data_start(self, auth_headers):
        """Test POST //remote/examinee-data/start endpoint with minimal viable payload."""
        path = "//remote/examinee-data/start"
        ...
        payload = self.get_remote_examinee_data_payload()
    ...
    def test_remote_examinee_data_login(self, auth_headers):
        """Test POST //remote/examinee-data/login endpoint with minimal viable payload."""
        path = "//remote/examinee-data/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /remote/examinee-data resource."""
        return ["//remote/examinee-data/start", "//remote/examinee-data/login"]
