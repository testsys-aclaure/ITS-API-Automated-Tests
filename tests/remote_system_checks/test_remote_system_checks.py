...
class TestRemoteSystemChecksEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_remote_system_checks_payload(self) -> dict:
        """Get the minimal viable payload for /remote/system-checks endpoints."""
        return {
    ...
    def test_remote_system_checks_start(self, auth_headers):
        """Test POST //remote/system-checks/start endpoint with minimal viable payload."""
        path = "//remote/system-checks/start"
        ...
        payload = self.get_remote_system_checks_payload()
    ...
    def test_remote_system_checks_login(self, auth_headers):
        """Test POST //remote/system-checks/login endpoint with minimal viable payload."""
        path = "//remote/system-checks/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /remote/system-checks resource."""
        return ["//remote/system-checks/start", "//remote/system-checks/login"]
