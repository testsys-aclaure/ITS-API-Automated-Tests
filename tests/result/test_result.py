"""Test suite for RESULT API endpoints."""
...
class TestResultEndpoints(APITestBase):
    """Test RESULT resource endpoints."""
    ...
    def test_result_query(self, auth_headers):
        """Test /result/query endpoint."""
        path = "/result/query"
