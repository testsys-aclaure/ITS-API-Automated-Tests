...
class TestRemotePracticeChecksEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_remote_practice_checks_payload(self) -> dict:
        """Get the minimal viable payload for /remote/practice-checks endpoints."""
        return {
    ...
    def test_remote_practice_checks_start(self, auth_headers):
        """Test POST //remote/practice-checks/start endpoint with minimal viable payload."""
        path = "//remote/practice-checks/start"
        ...
        payload = self.get_remote_practice_checks_payload()
    ...
    def test_remote_practice_checks_login(self, auth_headers):
        """Test POST //remote/practice-checks/login endpoint with minimal viable payload."""
        path = "//remote/practice-checks/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /remote/practice-checks resource."""
        return ["//remote/practice-checks/start", "//remote/practice-checks/login"]
