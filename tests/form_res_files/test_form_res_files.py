...
class TestFormResFilesEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_form_res_files_payload(self) -> dict:
        """Get the minimal viable payload for /form/res-files endpoints."""
        return {
    ...
    def test_form_res_files_start(self, auth_headers):
        """Test POST //form/res-files/start endpoint with minimal viable payload."""
        path = "//form/res-files/start"
        ...
        payload = self.get_form_res_files_payload()
    ...
    def test_form_res_files_login(self, auth_headers):
        """Test POST //form/res-files/login endpoint with minimal viable payload."""
        path = "//form/res-files/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /form/res-files resource."""
        return ["//form/res-files/start", "//form/res-files/login"]
