...
class TestRemoteSessionDataEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_remote_session_data_payload(self) -> dict:
        """Get the minimal viable payload for /remote/session-data endpoints."""
        return {
    ...
    def test_remote_session_data_start(self, auth_headers):
        """Test POST //remote/session-data/start endpoint with minimal viable payload."""
        path = "//remote/session-data/start"
        ...
        payload = self.get_remote_session_data_payload()
    ...
    def test_remote_session_data_login(self, auth_headers):
        """Test POST //remote/session-data/login endpoint with minimal viable payload."""
        path = "//remote/session-data/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /remote/session-data resource."""
        return ["//remote/session-data/start", "//remote/session-data/login"]
