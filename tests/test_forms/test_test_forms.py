...
class TestTestFormsEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_test_forms_payload(self) -> dict:
        """Get the minimal viable payload for /test/forms endpoints."""
        return {
    ...
    def test_test_forms_start(self, auth_headers):
        """Test POST //test/forms/start endpoint with minimal viable payload."""
        path = "//test/forms/start"
        ...
        payload = self.get_test_forms_payload()
    ...
    def test_test_forms_login(self, auth_headers):
        """Test POST //test/forms/login endpoint with minimal viable payload."""
        path = "//test/forms/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /test/forms resource."""
        return ["//test/forms/start", "//test/forms/login"]
