...
class TestExamineeLongitudinalSegmentDetailEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_examinee_longitudinal_segment_detail_payload(self) -> dict:
        """Get the minimal viable payload for /examinee/longitudinal-segment-detail endpoints."""
        return {
    ...
    def test_examinee_longitudinal_segment_detail_start(self, auth_headers):
        """Test POST //examinee/longitudinal-segment-detail/start endpoint with minimal viable payload."""
        path = "//examinee/longitudinal-segment-detail/start"
        ...
        payload = self.get_examinee_longitudinal_segment_detail_payload()
    ...
    def test_examinee_longitudinal_segment_detail_login(self, auth_headers):
        """Test POST //examinee/longitudinal-segment-detail/login endpoint with minimal viable payload."""
        path = "//examinee/longitudinal-segment-detail/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /examinee/longitudinal-segment-detail resource."""
        return ["//examinee/longitudinal-segment-detail/start", "//examinee/longitudinal-segment-detail/login"]
