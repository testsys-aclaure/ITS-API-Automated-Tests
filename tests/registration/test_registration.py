...
class TestRegistrationEndpoints(APITestBase):
    """Test REGISTRATION resource endpoints."""
    ...
    def test_registration_query(self, auth_headers):
        """Test /registration/query endpoint."""
