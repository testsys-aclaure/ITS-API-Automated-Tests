...
class TestFormDefinitionEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_form_definition_payload(self) -> dict:
        """Get the minimal viable payload for /form/definition endpoints."""
        return {
    ...
    def test_form_definition_start(self, auth_headers):
        """Test POST //form/definition/start endpoint with minimal viable payload."""
        path = "//form/definition/start"
        ...
        payload = self.get_form_definition_payload()
    ...
    def test_form_definition_login(self, auth_headers):
        """Test POST //form/definition/login endpoint with minimal viable payload."""
        path = "//form/definition/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /form/definition resource."""
        return ["//form/definition/start", "//form/definition/login"]
