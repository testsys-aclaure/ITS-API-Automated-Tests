...
class TestStartTestEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_start_test_payload(self) -> dict:
        """Get the minimal viable payload for start-test endpoints."""
        return {
    ...
    def test_start_test_start(self, auth_headers):
        """Test POST /start-test/start endpoint with minimal viable payload."""
        ...
        payload = self.get_start_test_payload()
    ...
    def test_start_test_login(self, auth_headers):
        """Test POST /start-test/login endpoint with minimal viable payload."""
        path = "/start-test/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for start-test resource."""
        return ["/start-test/start", "/start-test/login"]
