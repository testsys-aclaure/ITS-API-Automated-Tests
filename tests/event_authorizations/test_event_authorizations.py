...
class TestEventAuthorizationsEndpoints(APITestBase):
    """Test START-TEST resource endpoints (POST operations)."""
    
    def get_event_authorizations_payload(self) -> dict:
        """Get the minimal viable payload for /event/authorizations endpoints."""
        return {
    ...
    def test_event_authorizations_start(self, auth_headers):
        """Test POST //event/authorizations/start endpoint with minimal viable payload."""
        path = "//event/authorizations/start"
        ...
        payload = self.get_event_authorizations_payload()
    ...
    def test_event_authorizations_login(self, auth_headers):
        """Test POST //event/authorizations/login endpoint with minimal viable payload."""
        path = "//event/authorizations/login"
    ...
    def get_resource_endpoints(self) -> list:
        """Get all POST endpoints for /event/authorizations resource."""
        return ["//event/authorizations/start", "//event/authorizations/login"]
